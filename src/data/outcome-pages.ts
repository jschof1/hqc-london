...
export const outcomePages: OutcomePage[] = [
  ...
  },
  {
    ...
    description: 'Tell HQC what you need cleaned and the result required. We will route your enquiry to the appropriate home, property, commercial or complex cleaning service.',
    message: 'You do not need to select the perfect service before contacting HQC. Start with the property or site, its current condition and what needs to happen next.',
    audience: 'Visitors who know their buyer type and need the correct enquiry route.',
    primaryCta: 'Submit Your Requirement',
    primaryHref: '#routed-quote-form',
    secondaryCta: 'Find My Service',
    secondaryHref: selector,
  ...
  },
  {
    slug: 'areas-we-cover',
    cluster: 'Locations',
    title: 'Cleaning Services Across London',
    seoTitle: 'Areas We Cover | Cleaning Services Across London | HQC',
    eyebrow: 'London coverage depends on service and team availability',
    primaryKeyword: 'cleaning services London areas',
    description: 'Check HQC cleaning-service coverage across London and selected Surrey areas. Availability depends on service type, postcode, team capacity and property requirements.',
    message: 'HQC provides cleaning services across London, with selected established coverage in Surrey. Availability depends on postcode, service required, property or site type, scheduling, team capacity and specialist requirements.',
    audience: 'Prospects checking geographic availability.',
    primaryCta: 'Check Availability for Your Postcode',
    primaryHref: `${quote}?intent=availability`,
    secondaryCta: 'Find My Service',
    secondaryHref: selector,
    proof: ['Coverage is reviewed for the postcode and service required', 'Availability depends on scheduling and team capacity', 'HQC confirms the appropriate route after reviewing the enquiry'],
  ...
  },
  {
    ...
    cluster: 'Locations',
    title: 'Professional Cleaning Services in East London',
    seoTitle: 'Cleaning Services East London | High Quality Clean',
    eyebrow: 'One useful East London hub at launch',
    primaryKeyword: 'cleaning services East London',
    description: 'Professional cleaning services in East London for homes, workplaces and managed properties. Check HQC availability across key East London locations.',
    message: 'HQC provides outcome-led cleaning for homes, workplaces and managed properties across selected East London areas. Tell us what you need the property or site to be ready for and we will help identify the appropriate service route.',
    ...
    primaryHref: `${quote}?area=east-london&intent=availability`,
    secondaryCta: 'Find My Service',
    secondaryHref: selector,
    proof: ['Shoreditch, Spitalfields and Whitechapel', 'Canary Wharf, Limehouse and Stratford', 'Coverage depends on postcode, service, scheduling and team availability'],
